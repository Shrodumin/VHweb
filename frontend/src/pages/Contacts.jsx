      ...
      {isImageLoading ? (
        ...
        <ContainerCard image="/intro/intro.jpg" className={styles.container}>
          ...
          <div className={styles.topSection}>
            <div className={styles.infoContainer} style={{ padding: "10px"}}>
              <h1>Kontakty</h1>
              <br />
              <br />
              <p><FaHouse className={styles.icon} /> Masarykovo náměstí 105,<br />675 71, Náměšť nad Oslavou</p>
              <p><b>IČ:</b> 28263511</p>
              <p><b>DIČ:</b> CZ28263511</p> <br/>
              <p>Společnost je zapsána v OR u Krajského soudu v Brně, spisová značka C 57230 </p>
            </div>
          ...
          <div className={styles.cardContainer}>
            ...
            <Card className={styles.contactCard}>
              <Card.Body>
                ...
                <Card.Text>
                  <RiBuilding3Fill className={styles.icon}/>Újezd u Rosic ev. č. 26<br />
                  66484 Újezd u Rosic
                </Card.Text>
              </Card.Body>
            </Card>
